...
app.use('/shop-register', indexRouter);
app.use('/food-register', indexRouter);
app.use('/seller-register', indexRouter);
app.use('/seller-register', indexRouter);
app.use('/products', indexRouter);
app.use('/api/products/:id', indexRouter);
