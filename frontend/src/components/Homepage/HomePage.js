...
const images = [
  ...
  'https://plus.unsplash.com/premium_photo-1661884973994-d7625e52631a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80',
];
...
const Chatbox = () => {
  ...
  const handleSubmit = () => {
    ...
    axios.post('/api/messages', userQuestion)
      .then(() => {
        setTimeout(() => {
