          ...
          <ul className="nav-menu-items">
            ...
            {!isLoggedIn ? (
              <NavDropdown title="Sign Up" id="signup-dropdown" className="signup-dropdown">
                <li>
                  <NavLink exact to="/signup" activeClassName="active" className="nav-link" onClick={handleClick}>
                    user
                  </NavLink>
                </li>
                <li>
                  <NavLink exact to="/signup/worker" activeClassName="active" className="nav-link" onClick={handleClick}>
                    Worker
                  </NavLink>
                </li>
                <li>
